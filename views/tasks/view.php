    ...
    <div class="left-column">
        ...
        <div class="response-card">
            ...
            <div class="feedback-wrapper">
                <?php if ($task->performer): ?>
                    <a href="<?= Url::to(['user/view', 'id' => $task->performer_id]) ?>" class="link link--block link--big">
                        <?= htmlspecialchars($task->performer->name ?? 'Исполнитель') ?>
                    </a>

                <?php else: ?>
                    <span class="link link--block link--big">Исполнитель не указан</span>
                <?php endif; ?>
    ...
    <div class="right-column">
        <div class="right-card black info-card">
            ...
            <dl class="black-list">
                ...
                <dd><?= Yii::$app->formatter->asDate($task->due_date, 'long') ?></dd>
                <dt>Статус</dt>
                ...
                <ul class="enumeration-list">
                    <?php foreach ($task->files as $file): ?>
                        <li class="enumeration-item">
                            <a href="<?= Url::to(['file/download', 'id' => $file->id]) ?>" class="link link--block link--clip">
